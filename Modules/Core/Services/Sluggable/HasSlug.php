...
use Modules\Core\Services\Sluggable\Exceptions\InvalidOption;
...
trait HasSlug
{
    ...
    protected function generateNonUniqueSlug(): string
    {
        ...
        return Slug::make($this->getSlugSourceString(), $this->slugOptions->slugSeparator, $this->slugOptions->slugLanguage);
    }
    ...
    {
        return in_array('Modules\Core\Custom\Query\Traits\SoftDeletes', class_uses($this), true);
    }
