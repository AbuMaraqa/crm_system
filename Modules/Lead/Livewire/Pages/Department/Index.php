...
namespace Modules\Lead\Livewire\Pages\Department;
...
class Index extends Component implements HasForms, HasTable
{
            ...
            ->columns([
                ...
                TextColumn::make('locale')
                    ...
                    ->state(function (Department $department) {
                        return array_keys($department->getTranslationsArray());
                    })
                    ->alignCenter()
                    ->sortable(query: function (Builder $query): Builder {
                ...
                TextColumn::make('created_by')
                    ->label(__('Created By'))
                    ->state(function (Department $department) {
                        return $department->translateOrDefault()->user;
                    })
                    ->formatStateUsing(function (Department $department) {
                        return $department->translateOrDefault()->user->renderAsTableColumn();
                    })
                    ->html()
                    ->wrap(),
    ...
    public function createAction(): CreateAction
    {
        return CreateAction::make('create')
            ...
            ->modalHeading(__('Create Department'))
            ...
            ->visible(fn(): bool => auth()->user()->can('dashboard.lead.departments.create'))
            ->extraAttributes([
