                    ...
                    <div class="inner-bottom-header">
                        ...
                        <div class="cols">
                            <div class="header-search">
                                <form class="bb-btn-group-form" wire:submit.prevent="searchProduct">
                                    ...
                                    <input class="form-control bb-search-bar" wire:model="searchProductInput" placeholder="Search products..."
                                        type="text">
                        ...
                        <div class="bb-tags">
                            <ul>
                                @foreach ($categories as $category)
                                    <li>
                                        <button
                                        wire:click.prevent="selectCategory({{ $category->id }})">{{ $category->title }}</button>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
