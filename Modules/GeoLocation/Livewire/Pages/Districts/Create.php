...
class Create extends Component implements HasForms
{
    ...
    {
        $this->authorize('create_district');
    ...
    public function render()
    {
        ...
        return view('geolocation::livewire.pages.districts.create')
            ->layout(AppLayouts::class, [
                'pageTitle' => __('Create District'),
                'breadcrumbs' => [
                    route('dashboard.home') => __('Home'),
                    route('dashboard.geolocation.districts') => __('Districts'),
                    route('dashboard.geolocation.districts.create') => __('Create District'),
                ],
