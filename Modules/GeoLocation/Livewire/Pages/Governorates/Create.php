...
class Create extends Component implements HasForms
{
    ...
    public function render()
    {
        ...
        return view('geolocation::livewire.pages.governorates.create')
            ->layout(AppLayouts::class, [
                'pageTitle' => __('Create Governorate'),
                'breadcrumbs' => [
                    route('dashboard.home') => __('Home'),
                    route('dashboard.geolocation.governorates') => __('Governorates'),
                    route('dashboard.geolocation.governorates.create') => __('Create Governorate'),
                ],
